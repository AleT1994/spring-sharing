...
fetch(linkRisorsa)
    ...
    .then(res => {
        for (var i = 0; i < res.length; i++) {
            ...
            '</h2>' +
            '<div id="collapse' + i + '" class="accordion-collapse collapse" aria-labelledby="heading' + i + '" data-bs-parent="#accordionExample"><div class="accordion-body"><p>'+autonomia+'</p><p>'+posiz+'</p><div class="d-flex mb-3">' + 
